...
"));
  ...
  model ModelTemplateDocumentation "Template documentation for models"
    extends Modelica.Icons.Information;
...
<p><img src=\"modelica://Annex60/Resources/Images/Documentation/stars0.png\"/></p>
...
<li>3 stars: the model comes with examples for verification, showing its correct functioning. Implementation of models from literature recieve a maximum of 3 stars as long as no validation of the specific model was done.</li>
<li>4 stars: the model comes with examples for validation for this specific model; a comparison with measurement data includes an error analysis</li>
<li>5 stars: the model documentation includes a link to publications which show model validation for this specific model and can be cited by others</li>
</ul>
<p><br>The folder Resources.Images.Documentation contains images star0.png - star5.png. Replace the image above as appropriate.</p>
