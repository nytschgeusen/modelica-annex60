within Annex60.Building.LowOrder.BaseClasses;
model ReducedOrderModel
  ...
  Annex60.Utilities.Interfaces.Star internalGainsRad annotation (Placement(
        transformation(extent={{70,-100},{90,-80}}), iconTransformation(extent=
            {{54,-102},{100,-58}})));
  ...
  Annex60.Utilities.Interfaces.SolarRad_in solarRad_in if withWindows and
    withOuterwalls annotation (Placement(transformation(extent={{-102,60},{-82,
            80}}, rotation=0), iconTransformation(extent={{-102,34},{-60,74}})));
