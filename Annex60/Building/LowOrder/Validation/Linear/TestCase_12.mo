...
model TestCase_12
  ...
  BaseClasses.ReducedOrderModel.ReducedOrderModelVDI
                                                  reducedModel(                    Aw = 7,                     epsi = 1, epso = 1, T0all(displayUnit = "K") = 295.15, R1i = 0.000595515, Ai = 75.5,                                         Ao = 10.5, splitfac = 0.09, epsw = 1, g = 1, airload(V = 0.1), alphaiwi = 2.2,
    C1i=1.48362e+007,
    RRest=0.042768721,
    R1o=0.004367913,
    C1o=1.6008e+006)                                                                                                     annotation(Placement(transformation(extent={{54,30},
            {88,70}})));
