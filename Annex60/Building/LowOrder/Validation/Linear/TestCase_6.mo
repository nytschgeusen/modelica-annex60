within Annex60.Building.LowOrder.Validation.Linear;
model TestCase_6
  ...
  Utilities.HeatTransfer.HeatToStar HeatToStar(A = 2) annotation(Placement(transformation(extent = {{40, -98}, {60, -78}})));
