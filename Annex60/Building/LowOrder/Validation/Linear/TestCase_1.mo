...
model TestCase_1
  ...
  BaseClasses.ReducedOrderModel.ReducedOrderModelVDI
                                                  reducedModel(Ao = 10.5, Aw = 0.000000001, Ai = 75.5, epsi = 1, epso = 1, epsw = 1, g = 1,                                 splitfac = 0.09, R1i = 0.000595515,                     withWindows = false,
    C1i=1.4836200e+007,
    RRest=0.042768721,
    R1o=0.004367913,
    C1o=1.60080e+006,
    alphaiwi=2.236423594,
    alphaowi=2.699999358)                                                                                                     annotation(Placement(transformation(extent = {{0, 0}, {34, 34}})));
