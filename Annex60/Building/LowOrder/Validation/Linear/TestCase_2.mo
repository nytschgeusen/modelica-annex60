...
model TestCase_2
  ...
  BaseClasses.ReducedOrderModel.ReducedOrderModelVDI                reducedModel(Aw = 0.000000001, Ai = 75.5, epsi = 1, epso = 1, epsw = 1, g = 1, alphaiwi = 2.2, alphaowi = 2.7, splitfac = 0.09, R1i = 0.000595515,                     withWindows = false,                                                             Ao = 10.5,
    C1i=1.4836200e+007,
    RRest=0.042768721,
    R1o=0.004367913,
    C1o=1.60080e+006)                                                                                                     annotation(Placement(transformation(extent = {{12, 10}, {46, 44}})));
  Modelica.Blocks.Sources.CombiTimeTable tableMachines(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic, tableName = "UserProfilesOffice", fileName = "./Tables/J1615/UserProfilesOffice.txt", tableOnFile = false, table = [0, 0; 3600, 0; 7200, 0; 10800, 0; 14400, 0; 18000, 0; 21600, 0; 21600, 1000; 25200, 1000; 28800, 1000; 32400, 1000; 36000, 1000; 39600, 1000; 43200, 1000; 46800, 1000; 50400, 1000; 54000, 1000; 57600, 1000; 61200, 1000; 64800, 1000; 64800, 0; 68400, 0; 72000, 0; 75600, 0; 79200, 0; 82800, 0; 86400, 0], columns = {2}) annotation(Placement(transformation(extent = {{2, -73}, {16, -59}})));
