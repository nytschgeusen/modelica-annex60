...
model TestCase_10
  ...
  BaseClasses.EqAirTemp.EqAirTempSimple
                        eqAirTemp_TestCase_8_1(alphaowo = 25, wf_ground = 0.629038674, n = 5, wf_wall = {0.000000000, 0.000000000, 0.046454666, 0.000000000, 0.0}, wf_win = {0.000000000, 0.000000000, 0.324506660, 0.000000000, 0.0},
    T_ground=288.15,
    withLongwave=false)                                                                                                     annotation(Placement(transformation(extent = {{-36, 30}, {-16, 50}})));
  ...
  BaseClasses.ReducedOrderModel.ReducedOrderModelStar
                                                  reducedModel(R1i = 0.000779672, C1i = 1.23140e+07, Ai = 58, splitfac = 0.09, Aw = 7, epsw = 1, RRest = 0.014406788, R1o = 0.001719315, C1o = 4.33875e+06, Ao = 28, alphaiwi = 2.4, alphaowi = 2.1, epsi = 1, epso = 1, g = 1, T0all = 290.75) annotation(Placement(transformation(extent = {{50, 42}, {98, 92}})));
...
equation
  ...
  connect(machinesConvective.port, reducedModel.internalGainsConv) annotation(Line(points = {{40, -42}, {78.8, -42}, {78.8, 47}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(outdoorTemp.y, eqAirTemp_TestCase_8_1.weatherData) annotation (Line(
      points={{-79,22},{-44,22},{-44,40},{-34,40}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(eqAirTemp_TestCase_8_1.equalAirTemp, reducedModel.equalAirTemp)
    annotation (Line(
      points={{-18,34.4},{0,34.4},{0,34},{20,34},{20,68},{54.8,68}},
      color={191,0,0},
      smooth=Smooth.None));
