...
equation
  ...
  connect(eqAirTemp.equalAirTemp, reducedModel.equalAirTemp) annotation(Line(points={{-0.2,
          4.4},{8,4.4},{8,27.76},{42.2,27.76}},                                                                                       color = {191, 0, 0}, smooth = Smooth.None));
