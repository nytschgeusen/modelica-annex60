within Annex60.Experimental.SolarHeatingSystem.Components.ThermalStorages.BaseClasses.StratificationModel;
package Examples
extends Modelica.Icons.ExamplesPackage;
  ...
  extends Modelica.Icons.Example;
    ...
    Annex60.Fluid.Sources.MassFlowSource_T boundary1(
    ...
    Annex60.Fluid.Sources.FixedBoundary bou2(
      redeclare package Medium = Medium,
      nPorts=1)
    ...
    Annex60.Fluid.Sources.FixedBoundary bou3(
      redeclare package Medium = Medium, nPorts=1)
