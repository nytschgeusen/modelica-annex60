within Annex60.Experimental.SolarHeatingSystem.Components.ThermalStorages;
model FluidStorage "Model of a thermal fluid storage"
  replaceable package Medium = Modelica.Media.Interfaces.PartialMedium
    "Medium of the storage model";
  Annex60.Fluid.MixingVolumes.MixingVolume vol[nEle - 2](
...
public
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume vol_HX_1(
    nPorts = 2,
    redeclare package Medium = Medium,
    m_flow_nominal = 1.0,
    V = 0.05,
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume vol_HX_2(
    nPorts = 2,
    m_flow_nominal = 1.0,
    redeclare package Medium = Medium,
    V = 0.05,
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume vol_bot(
    redeclare package Medium = Medium,
    each m_flow_nominal = 1.0,
    each V = V / nEle,
    each T_start = T_start,
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume vol_top(
    redeclare package Medium = Medium,
    each m_flow_nominal = 1.0,
    each V = V / nEle,
    each T_start = T_start,
  ...
  Annex60.Fluid.FixedResistances.LosslessPipe pip[nEle - 2](
    redeclare package Medium = Medium,
    each m_flow_nominal = 1.0)
